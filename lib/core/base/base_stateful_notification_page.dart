...
abstract class BaseStatefulNotificationPage<T extends StatefulWidget>
  ...
  TextStyle get tabBarText => textTheme.bodyText1.copyWith(color: colorScheme.secondary,fontSize: 18);
  TextStyle get followedText => textTheme.subtitle1.copyWith(fontWeight: FontWeight.bold);
